...
::File EnablePowershell.ps1 not found
cls
::zwart/rood
color 0c
title ERROR
...
echo          **************************************************
echo          *                                                *
echo          *       EnablePowershell.ps1 niet gevonden!      *
echo          *                                                *
echo          *       Plaats het bestand in dezelfde map       *
echo          *       als het script.                          *
echo          *                                                *
...
:error_delete_bloatware
::File Windows10Debloater.ps1 not found
cls
::zwart/rood
color 0c
title ERROR
...
echo          **************************************************
echo          *                                                *
echo          *       Windows10Debloater.ps1 niet gevonden!    *
echo          *                                                *
echo          *       Plaats het bestand in dezelfde map       *
echo          *       als het script.                          *
echo          *                                                *
